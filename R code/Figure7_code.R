...
svg("Figure7G_STGG1_fov22_CD4_trajectory.svg",width=6,height = 4)
ImageDimPlot(nano.obj.with.label.transfer,fov = "STGG1_fov22",
...
svg("Figure7G_STGU3_fov2_CD4_trajectory.svg",width=6,height = 4)
ImageDimPlot(nano.obj.with.label.transfer,fov = "STGU3_fov2",
             cols = c("#8A817C","#80ED99","#8A817C","#8A817C","#8A817C","#008000","red","black",
                      "black","black","black","black","black","black","black","black"),
             border.color = "white")+NoLegend()+
  theme(plot.margin = margin(0,0,0,0),legend.position = "bottom",axis.text=element_text(face="bold", size=7,colour = 'white'))
...
svg("Figure7G_STGU1_fov26_CD4_trajectory.svg",width=6,height = 4)
ImageDimPlot(nano.obj.with.label.transfer,fov = "STGU1_fov26",
             cols = c("#8A817C","#80ED99","#8A817C","#8A817C","#8A817C","#008000","red","black",
                      "black","black","black","black","black","black","black","black"),
             border.color = "white")+NoLegend()+
  theme(plot.margin = margin(0,0,0,0),legend.position = "bottom",axis.text=element_text(face="bold", size=7,colour = 'white'))
...
svg("Figure7G_STGU1_fov8_CD4_trajectory.svg",width=6,height = 4)
ImageDimPlot(nano.obj.with.label.transfer,fov = "STGU1_fov8",
             cols = c("#8A817C","#80ED99","#8A817C","#8A817C","#8A817C","#008000","red","black",
                      "black","black","black","black","black","black","black","black"),
             border.color = "white")+NoLegend()+
  theme(plot.margin = margin(0,0,0,0),legend.position = "bottom",axis.text=element_text(face="bold", size=7,colour = 'white'))
