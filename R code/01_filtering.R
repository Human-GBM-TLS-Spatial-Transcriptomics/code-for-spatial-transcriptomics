...
|sample_id  | n.before| n.after|     %| reporter.before| reporter.after| control.before| control.after|
  |:----------|--------:|-------:|-----:|---------------:|--------------:|--------------:|-------------:|
  |Run5753_S1 |    39590|   39241| 99.12|            5.77|           5.79|           0.65|          0.65|
  |Run5753_S2 |    60259|   59612| 98.93|            5.93|           5.95|           0.83|          0.83|
  |Run5753_S3 |    45062|   43937| 97.50|            5.28|           5.34|           0.61|          0.62|
  |Run5753_S4 |    23462|   22985| 97.97|            5.53|           5.58|           0.73|          0.74|
...
library(rgeos)
basal.crop <- Crop(nano.obj[["Run5753_S1"]], x = c(40000, 50000), y = c(-415000, -430000))
...
ImageDimPlot(nano.obj, fov = "zoom1", cols = "polychrome", alpha = 0.3, molecules = c("KRT17", "IL7R",
                                                                                      "TPSAB1"), mols.size = 0.5, nmols = 20000, border.color = "black", coord.fixed = FALSE)
